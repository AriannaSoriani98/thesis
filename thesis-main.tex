...
\usepackage{acronym}
\usepackage{makecell} % Pacchetto per andare a capo nelle celle
\usepackage{xcolor}
\usepackage{colortbl} % Per colorare le tabelle
\usepackage{booktabs} % Per migliorare l'estetica delle tabelle
\usepackage{longtable} % per gestire tabelle lunghe
...
\title{Identificazione umana mediante radiografie dentali per applicazioni forensi}
...
\item \textbf{remove\_isolated\_gray\_regions}:\\
Questo processamento è utile al fine di ottenere una maschera binaria pulita, in cui vengono eliminati i rumori e gli artefatti, mentre vengono mantenute solo le aree rilevanti. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Discussione risultati}
%\hspace*{-1cm} % Sposta la tabella verso sinistra di 1 cm
\begin{table}[ht]
    \centering
    \renewcommand{\arraystretch}{2}
    % Definizione di un colore personalizzato (facoltativo)
    \definecolor{headercolor}{RGB}{220, 230, 241}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
    \hline
   \rowcolor{headercolor} % Colore dell'intestazione
    \textbf{\makecell{Uso\\masks}} & \textbf{\makecell{Rete\\generaz.\\masks}} & \textbf{\makecell{Pre-proc.\\OPT}} & \textbf{\makecell{Post-proc.\\masks}} & \textbf{Dilataz.} & \textbf{\makecell{Area\\Ricerca}} & \textbf{\makecell{Tecnica\\def.\\RoI}} & \textbf{\makecell{Ratio\\Test}} & \textbf{\makecell{Rank\\@1}} & \textbf{\makecell{Rank\\@3}} & \textbf{\makecell{Rank\\@5}} & \textbf{\makecell{Tempi\\(s/it)}} \\
    \hline
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}
    \hline
   \rowcolor{headercolor} % Colore dell'intestazione
    \textbf{extended} & \textbf{upright} & \textbf{\makecell{hessian\\Threshold}}& \textbf{nOctave} & \textbf{\makecell{nOctave\\Layers}} & 
    \textbf{RANSAC} & \textbf{Matcher} & \textbf{\makecell{Rank\\@1}} & \textbf{\makecell{Rank\\@3}} & \textbf{\makecell{Rank\\@5}} & \textbf{\makecell{Tempi\\(s/it)}} \\
    \hline
    \rowcolor{yellow}
    \textbf{True} & \textbf{True} & \textbf{600} & \textbf{5} & \textbf{4} & \textbf{3.0} & \textbf{BF} & \textbf{0.79} & \textbf{0.86} & \textbf{0.87} & \textbf{1.8}\\
    \hline
    False & False & 100 & 4 & 3 & 7.0 & FLANN & 0.5 & 0.62 & 0.67 & 16.8\\
    \hline
    False & False & 100 & 4 & 3 & 5.0 & FLANN & 0.49 & 0.62 & 0.67 & 16.8\\
    \hline
    True & False & 100 & 4 & 3 & 5.0 & FLANN & 0.55 & 0.65 & 0.65 & 16.2\\
    \hline
    True & False & 0 & 4 & 3 & 4.0 & FLANN & 0.19 & 0.31 & 0.44 & 30.2\\
    \hline
    True & True & 100 & 4 & 3 & 4.0 & FLANN & 0.51 & 0.75 & 0.78 & 18.6\\
    \hline
    True & True & 100 & 4 & 3 & 2.0 & FLANN & 0.50 & 0.75 & 0.79 & 19.2\\
    \hline
    True & True & 500 & 4 & 3 & 3.0 & BF & 0.73 & 0.85 & 0.85 & 2.4\\
    \hline
    True & False & 500 & 4 & 3 & 3.0 & BF & 0.59 & 0.69 & 0.71 & 2.4\\
    \hline
    True & True & 500 & 5 & 4 & 3.0 & BF & 0.79 & 0.86 & 0.86 & 2.4\\
    \hline
    True & True & 500 & 5 & 4 & 2.0 & BF & 0.76 & 0.85 & 0.86 & 2.4\\
    \hline
    True & True & 1000 & 4 & 3 & 3.0 & BF & 0.74 & 0.80 & 0.80 & 0.6\\
    \hline
    True & True & 0 & 4 & 3 & 3.0 & BF & 0.29 & 0.58 & 0.64 & 3.0\\
    \hline
